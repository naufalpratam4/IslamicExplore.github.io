...
@section('content')
    <div>
        <div class="font-semibold text-2xl pb-2">Pesan</div>
                ...
                <tbody>
                    @foreach ($pesan as $item)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4 text-red-500 hover:text-red-600">
                                ...
                                {{-- Modal --}}
                                <div id="popup-modal-{{ $item->id }}" tabindex="-1" aria-hidden="true"
                                    class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                                    <div class="relative p-4 w-full max-w-md max-h-full">
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            <a href="/admin/contact"><button type="button"
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are
                                                    you sure you want to delete this message?</h3>
                                                <div class="flex justify-center">
                                                    <div>
                                                        <form action="{{ route('delete.pesan', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
